...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { match_id: @move.match_id, square_id: @move.square_id, user_id: @move.user_id, value: @move.value }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { match_id: @move.match_id, square_id: @move.square_id, user_id: @move.user_id, value: @move.value }
    assert_redirected_to move_path(assigns(:move))
  end
